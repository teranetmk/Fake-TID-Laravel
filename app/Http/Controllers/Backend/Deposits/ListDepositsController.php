...
namespace App\Http\Controllers\Backend\Deposits;
...
use Auth;
class ListDepositsController extends Controller
{
    ...
    public function __invoke(AnalyticsRequest $request)
    {
        ...
        return view(
            ...
            [
                ...
                'yearStartDate'         => $currentYear->getStartDate(),
                'yearEndDate'           => $currentYear->getEndDate(),
                'accountsSalesChart'    => $this->analyticsService->getAccountsDepositsChart($period),
                'tidsSalesChart'        => $this->analyticsService->getTidsDepositsChart($period),
                'yearAccountsSalesChart'=> $this->analyticsService->getAccountsDepositsChart($currentYear, true),
                'yearTidsSalesChart'    => $this->analyticsService->getTidsDepositsChart($currentYear, true),
                'todaySales'            => $this->analyticsService->getTodayDeposits(),
                'yesterdaySales'        => $this->analyticsService->getYesterdayDeposits(),
                'currentWeekSales'      => $this->analyticsService->getCurrentWeekDeposits(),
                'currentMonthSales'     => $this->analyticsService->getCurrentMonthDeposits(),
                'currentYearSales'      => $this->analyticsService->getCurrentYearDeposits(),
            ]
        );
    }
}