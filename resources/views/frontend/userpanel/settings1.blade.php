                    ...
                    <form method="post" action="{{ route('settings-password-change') }}"
                        ...
                        {{--
                                                <div class="form-group row">
                                                    <label for="settings_current_password" class="col-md-4 col-form-label text-md-right">{{ __('frontend/user.settings_current_password') }}</label>

                                                    <div class="col-md-6">
                                                        <input id="settings_current_password" type="password" class="br-outline-input form-control{{ $errors->has('settings_current_password') ? ' is-invalid' : '' }}" name="settings_current_password" value="{{ old('settings_current_password') }}" required autofocus>
                        ...
                        {{--
                                                <div class="form-group row">
                                                    <label for="settings_new_password" class="col-md-4 col-form-label text-md-right">{{ __('frontend/user.settings_new_password') }}</label>

                                                    <div class="col-md-6">
                                                        <input id="settings_new_password" type="password" class="br-outline-input form-control{{ $errors->has('settings_new_password') ? ' is-invalid' : '' }}" name="settings_new_password" value="{{ old('settings_new_password') }}" required autofocus>
                        ...
                        {{--
                        <div class="form-group row">
                            <label for="settings_new_password_confirm" class="col-md-4 col-form-label text-md-right">{{ __('frontend/user.settings_new_password_confirm') }}</label>

                            <div class="col-md-6">
                                <input id="settings_new_password_confirm" type="password" class="br-outline-input form-control{{ $errors->has('settings_new_password_confirm') ? ' is-invalid' : '' }}" name="settings_new_password_confirm" value="{{ old('settings_new_password_confirm') }}" required autofocus>
                        ...
                        <div class="row mt-2 mb-3 col-md-7">
                            <div class="">
                                <div class="form-outline ml-3">
                                    <button type="submit"
                                            class="btn btn-red d-block ml-auto mr-0">
