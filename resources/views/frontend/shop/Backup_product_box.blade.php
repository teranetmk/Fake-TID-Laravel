                            ...
                            <div class="col-md-10 offset-md-1">
                                <div class="row">
                                    <div class=" col-8 col-lg-8 only-p-left mt-15-991">
                                        ...
                                        @else
                                            <select name="product_amount"
                                                ...
                                                @if($product->isSoldOut() || (! $product->isAvailable() && ($product->name !== 'Nachnahme Boxing'))) disabled @endif>

                                                @if($product->isSoldOut() || (! $product->isAvailable() && ($product->name !== 'Nachnahme Boxing')))
                                    ...
                                    <div class="col-4 col-lg-4 only-p-right">
                                        <button type="submit"
                                                class="btn btn-icon btn-block btn-red @if($product->isSoldOut() || (! $product->isAvailable() && ($product->name !== 'Nachnahme Boxing'))) disabled @endif"
                                                @if($product->isSoldOut() || (! $product->isAvailable() && ($product->name !== 'Nachnahme Boxing'))) disabled="true" @endif>
