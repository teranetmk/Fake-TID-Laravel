    ...
    <div class="k-content__body	k-grid__item k-grid__item--fluid">
        ...
        <div class="navbar navbar-expand-lg">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item">
                    <form action="{{ route( 'myorders-orders-with-pageNumber', 1 ) }}" method="get" class="row">
                ...
                <li class="nav-item">
                    ...
                    <a href="{{route('my-orders')}}"  class="btn btn-brand mx-4">{{ __('backend/orders.fiters.clear_filter') }}</a>
