            ...
            <div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
                <div class="k-portlet k-portlet--height-fluid">
                    ...
                    <ul class="list-group">
                        ...
                        @if($product->name !== 'Nachnahme Boxing' && ! $order->products->isDigitalGoods())
                        ...
                        <li class="list-group-item">
                            ...
                            <form action="{{ route( 'partner-order-setStatus', ['id' => $order->id] ) }}" method="post"
                                  class="input-group">
                        ...
                        @if($product->name !== 'Nachnahme Boxing' && ! $order->products->isDigitalGoods() && ! is_null($order->tid))
                            <li class="list-group-item">
                                <b>TID:</b> {{ $order->qrcode }}
                            </li>
                        @endif

                        <!-- @if(! $order->products->isDigitalGoods() && $product->name !== 'Nachnahme Boxing')
                        <li class="list-group-item">
                            <b>Versandart:</b> {{ $order->qrcode }}
                        </li>
                        @endif -->
