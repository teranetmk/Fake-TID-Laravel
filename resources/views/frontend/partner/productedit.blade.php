...
<div class="py-4 px-3 px-md-4">
	<nav class="d-none d-md-block" aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">{{ __('backend/management.products.edit.title') }}}</li>
        </ol>
    </nav>
		...
		<div class="row">
			<div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
				...
				<div class="kt-portlet">
					...
					<form method="post" class="kt-form" action="{{ route('partner-product-edit-form') }}" enctype="multipart/form-data">
						@csrf
						...
						<div class="kt-portlet__body">
							...
							<div class="form-group">
								...
								<input type="hidden" name="product_edit_category_id" value="{{$product->category_id}}">
								

								<div class="form-group">
									<label for="product_edit_description">{{ __('backend/management.products.description') }}</label>
									<textarea class="summernote form-control @if($errors->has('product_edit_description')) is-invalid @endif" id="product_edit_description" name="product_edit_description" placeholder="{{ __('backend/management.products.description') }}">{{ strlen($product->description) > 0 ? $product->description : '' }}</textarea>
