                                    ...
                                    <td style="font-size: 20px;">
                                        ...
                                        <a href="{{ route('backend-order-edit', $order->id) }}"
                                           ...
                                           data-original-title="{{ __('backend/orders.edit') }}"><i
                                                class="la la-edit @if(! is_null($order->address) && $order->address->recipient_first_name) text-success @else text-danger @endif"></i></a>
                                        ...
                                        <a href="{{ route('backend-order-delete', $order->id) }}"
                                           ...
                                           --}}
                                        <!-- <a target="_blank" href="{{ route( 'backend-orders-downloadTidFile', $order->id ) }}"
                                            data-toggle="tooltip"
                                            data-original-title="{{ __('backend/orders.download') }}"><i
                                                 class="la la-download"></i></a> -->
                                    </td>
