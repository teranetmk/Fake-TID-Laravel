...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	<head>
		...
		<meta name="author" content="FakeTIDs" />
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="{{ asset('https://i.imgur.com/vDkDjpK.png') }}" />
...
{{--									</div>--}}
								...
								<div class="k-header-menu-wrapper" id="k_header_menu_wrapper">
									<div id="k_header_menu" class="k-header-menu k-header-menu-mobile ">
										<ul class="k-menu__nav ">
											...
											<li class="k-menu__item @if(\Request::routeIs(['admin.profits', 'admin.profits.*']) || \Request::routeIs(['admin.commission', 'admin.commission.*'])) k-menu__item--here @endif k-menu__item--open k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
												<a href="javascript:;" class="k-menu__link k-menu__toggle">
													<span class="k-menu__link-text">Gewinn & Provision</span>
												...
												<div class="k-menu__submenu k-menu__submenu--classic k-menu__submenu--left">
													<ul class="k-menu__subnav">
														...
														@if(Auth::user()->hasPermission('see_profits'))
														<li class="k-menu__item  k-menu__item--open @if(\Request::routeIs(['admin.profits', 'admin.profits.*'])) k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
															<a href="{{ route('admin.profits') }}" class="k-menu__link">
																<span class="k-menu__link-text">{{ __('backend/profits.title') }}</span>
															</a>
														</li>
														@endif
														@if(Auth::user()->hasPermission('see_profits'))
														<li class="k-menu__item  k-menu__item--open @if(\Request::routeIs(['admin.commission', 'admin.commission.*'])) k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
															<a href="{{ route('employee-commission') }}" class="k-menu__link">
																<span class="k-menu__link-text">Mitarbeiterprovision</span>
															</a>
														</li>
														@endif
														@if(Auth::user()->hasPermission('see_profits'))
														<li class="k-menu__item  k-menu__item--open @if(\Request::routeIs(['admin.cashondelivery', 'admin.cashondelivery.*'])) k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
															<a href="{{ route('cashondelivery') }}" class="k-menu__link">
																<span class="k-menu__link-text">Nachnahme Provision</span>
															</a>
														</li>
														@endif
														@if(Auth::user()->hasPermission('see_profits'))
														<li class="k-menu__item  k-menu__item--open @if(\Request::routeIs(['admin.cashondelivery', 'admin.cashondelivery.*'])) k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
															<a href="{{ route('admin.deposits') }}" class="k-menu__link">
																<span class="k-menu__link-text">Einzahlungs-Statistik</span>
															</a>
														</li>
														@endif
													</ul>
											...
											@if(Auth::user()->hasPermission('manage_upload_tids'))
                                            <li class="k-menu__item  k-menu__item--open @if(\Route::currentRouteName() == 'backend-upload') k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
												<a href="{{ route('admin.uploads.index') }}" class="k-menu__link">
                                                    <span class="k-menu__link-text">{{ __('backend/tids.title') }}</span>
												</a>
											</li>
                                            @endif
											...
											@if(Auth::user()->hasAnyPermissionFromArray(['manage_orders', 'manage_orders_packstation', 'manage_orders_filialeinlieferung', 'manage_orders_lit_filling', 'manage_orders_lit_refund', 'manage_orders_nachnahme', 'manage_orders_random', 'manage_orders_accounts']))
											<li class="k-menu__item  k-menu__item--open @if(\Route::currentRouteName() == 'backend-orders') k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
											...
											<li class="k-menu__item  k-menu__item--open @if(\Route::currentRouteName() == 'backend-media') k-menu__item--here @endif k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
											...
											<li class="k-menu__item @if(isset($managementPage)) k-menu__item--here @endif k-menu__item--open k-menu__item--submenu k-menu__item--rel k-menu__item--open" data-kmenu-submenu-toggle="click" aria-haspopup="true">
												...
												<div class="k-menu__submenu k-menu__submenu--classic k-menu__submenu--left">
													<ul class="k-menu__subnav">
														...
														@if(Auth::user()->hasPermission('manage_delivery_methods'))
														<li class="k-menu__item" aria-haspopup="true">
															<a href="{{ route('backend-management-address-database') }}" class="k-menu__link ">
																<i class="k-menu__link-bullet k-menu__link-bullet--line">
																	<span></span>
																</i>
																<span class="k-menu__link-text">{{ __('backend/management.adressen_generator.title') }}</span>
															</a>
														</li>
														@endif
														@if(Auth::user()->hasPermission('short_links'))
														<li class="k-menu__item" aria-haspopup="true">
															<a href="{{ route('admin.shortlinks') }}" class="k-menu__link ">
																<i class="k-menu__link-bullet k-menu__link-bullet--line">
																	<span></span>
																</i>
																<span class="k-menu__link-text">{{ __('backend/shortlinks.title') }}</span>
															</a>
														</li>
														@endif
														@if(Auth::user()->hasPermission('manage_employees'))
														<li class="k-menu__item" aria-haspopup="true">
															<a href="{{ route('admin.employees') }}" class="k-menu__link ">
																<i class="k-menu__link-bullet k-menu__link-bullet--line">
																	<span></span>
																</i>
																<span class="k-menu__link-text">{{ __('backend/employees.title') }}</span>
															</a>
														</li>
														@endif
													</ul>
						...
						<div class="k-container">
							<div class="k-footer__bottom">
								<div class="k-footer__copyright">
									2021 &copy; Backend of FakeTIDs.to</a>.
								</div>
								<div class="k-footer__menu">
									<span style="font-size:11px;"><i>Backend of FakeTIDs.to</b></i></span>
								</div>
							</div>
						</div>
					</div>
		...
		<div class="modal fade" id="statusChangeForm" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route( 'backend-order-setBulkStatus') }}" method="post">
        @csrf
        <div class="modal-body">
          <div class="form-group">
            ...
            <input type="hidden" name="orderids" id="order_ids_input" value="">
        </div>
