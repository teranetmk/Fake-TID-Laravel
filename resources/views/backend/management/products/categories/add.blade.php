														...
														<div class="kt-section kt-section--first">
															...
															<div class="form-group">
																...
																<select name="is_show" class="form-control @if($errors->has('is_show')) is-invalid @endif">
																	...
																	<option value="yes" @if(old('is_show') == 'yes') selected @endif>Yes</option>
																	<option value="no" @if(old('is_show') == 'no') selected @endif>No</option>	
																</select>
															...
															<div style="margin-bottom: 5px;">
																<label class="k-checkbox k-checkbox--all k-checkbox--solid">
																	<input type="checkbox" name="product_category_add_is_digital_goods" value="1" data-content-visible="false" data-weight-visible="false"/>
																	<span></span>
																	Set as digital goods category
																</label>

																@if($errors->has('product_category_add_is_digital_goods'))
																	<span class="invalid-feedback" style="display:block" role="alert">
																		<strong>{{ $errors->first('product_category_add_is_digital_goods') }}</strong>
																	</span>
																@endif
															</div>
														</div>
