...
{{--    {{ dd(App\Models\User::find(1)->permissions()->get()) }}--}}
@if(Auth::user()->hasPermission('manage_orders'))
								...
								<div class="k-content__body	k-grid__item k-grid__item--fluid">
											...
											<div class="k-portlet  k-widget-12">
												<div class="k-portlet__body">
													<div class="k-widget-12__body">
														...
														<div class="k-widget-12__head">
															<div class="k-widget-12__label">
																<h3 class="k-widget-12__title">Accounts</h3>
																<span class="k-widget-12__desc">
																	{{ $getTodayEarningsOfDigitalProducts }}
																</span>
															</div>
														</div>
														<div class="k-widget-12__head">
															<div class="k-widget-12__label">
																<h3 class="k-widget-12__title">TIDs</h3>
																<span class="k-widget-12__desc">
																	{{ $getTodayEarningsOfNonDigitalProducts }}
																</span>
															</div>
														</div>
														<div class="k-widget-12__head">
															<div class="k-widget-12__label">
																<h3 class="k-widget-12__title">100% TIDs</h3>
																<span class="k-widget-12__desc">
																	{{ $getTodayEarningsOf100PercentTids }}
																</span>
															</div>
														</div>
														<div class="k-widget-12__head">
															<div class="k-widget-12__label">
																<h3 class="k-widget-12__title">Echte TIDs</h3>
																<span class="k-widget-12__desc">
																	{{ $getTodayEarningsOfOriginaleTids }}
																</span>
															</div>
														</div>
														<div class="k-widget-12__head">
															<div class="k-widget-12__label">
																<h3 class="k-widget-12__title">Belege</h3>
																<span class="k-widget-12__desc">
																	{{ $getTodayEarningsOfDigitalProductsBelege }}
																</span>
															</div>
														</div>
													</div>
									...
									<div class="row">
										<div class="col-lg-12 col-xl-12 order-lg-1 order-xl-1">
											...
											<!--begin::Portlet-->
											<div class="k-portlet k-portlet--height-fluid">
												<div class="k-portlet__head k-portlet__head--lg k-portlet__head--noborder k-portlet__head--break-sm" style="display:flex;flex-direction:row;align-items:center;justify-content:space-between">
													<div class="k-portlet__head-label">
														<h3 class="k-portlet__head-title">
        ...
        <form class="inline-form mb-4">
            <div class="row" style="display:flex;justify-content:flex-end;">
                <div class="col-lg-6">
                    <input id="ticket-search-term" type="text" name="term" value="" class="form-control" placeholder="Schlüsselwörter: Benutzername, Bestell-ID, DHL-Tracking-Nummer" autocomplete="off" />
                </div>
                <div class="col-lg-4" style="display:flex;justify-content:end;">
                    <button type="submit" class="btn btn-primary" id="ticket-search"><i class="fa fa-search"></i>&nbsp;Suche</button>
                </div>
            </div>
        </form>
	...
	<script type="text/javascript">
		var KDashboard = function() {
			...
			var recentTicketsInit = function() {
				...
				$('#ticket-search').on('click', function(e) {
					e.preventDefault();
					datatable.search($("#ticket-search-term").val().toLowerCase(), 'status');
				});
			};
