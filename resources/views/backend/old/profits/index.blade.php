...
<div class="k-content__body	k-grid__item k-grid__item--fluid">
    <div class="row mt-3 mb-2">
        <div class="col-md-7" style="padding: 0 !important;">
          <form style="padding: 0 !important;" id="periodForm" action="{{ route('admin.profits.in-period') }}" method="POST">
            @csrf
...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function () {
        ...
        window.ApexCharts && (new ApexCharts(document.getElementById('earnings-chart'), {
            ...
            series: [{
                name: "{{ __('backend/profits.tids') }}",
                data: {!! json_encode($tidsSalesChart) !!}
            }, {
                name: "{{ __('backend/profits.accounts') }}",
