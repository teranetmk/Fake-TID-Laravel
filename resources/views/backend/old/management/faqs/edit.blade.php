													...
													<div class="kt-portlet__body">
														<div class="kt-section kt-section--first">
															<div class="form-group">
																...
																<input type="text" class="form-control @if($errors->has('faq_edit_question')) is-invalid @endif" id="faq_edit_question" name="faq_edit_question" placeholder="{{ __('backend/management.faqs.question') }}" value="{{ $faq->question }}" />
															...
															<div class="form-group">
																...
																<textarea class="text-editor form-control @if($errors->has('faq_edit_answer')) is-invalid @endif" id="faq_edit_answer" name="faq_edit_answer" placeholder="{{ __('backend/management.faqs.answer') }}">{{ strlen($faq->answer) > 0 ? $faq->answer : '' }}</textarea>
