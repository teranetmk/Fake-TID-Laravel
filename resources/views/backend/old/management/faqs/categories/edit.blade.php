													...
													<div class="kt-portlet__body">
														<div class="kt-section kt-section--first">
															<div class="form-group">
																...
																<input type="text" class="form-control @if($errors->has('faq_category_edit_name')) is-invalid @endif" id="faq_category_edit_name" name="faq_category_edit_name" placeholder="{{ __('backend/management.faqs.categories.name') }}" value="{{ $faqCategory->name }}" />
