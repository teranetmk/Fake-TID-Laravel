									...
									<div class="row">
										<div class="col-lg-6 col-xl-4 order-lg-2 order-xl-1">
											...
											<div class="k-portlet">
												...
												<div class="k-portlet__body">
													<div class="form-group" style="width: 100%;">
														<input type="text" onClick="$(this).select()" class="form-control text-center" value="{{ App\Classes\BitcoinAPI::getBitcoinClient()->getnewaddress() }}" readonly />
													</div>
