<?php
    ...
    return [
        'btcpay_secret' => 'mBIJebrkVFkCguHhfVWaFOW3x',
        'name' => env('APP_NAME', ''),
        ...
        'url' => env('APP_URL', 'https://fake-tids.to'),
        ...
        'key' => env('APP_KEY', 'base64:gskq44BCyGC+Q91ZYudUGfnfRGn4hU3ycdX0YO5FqDw='),
        ...
        'aliases' => [
            ...
            'Backend' => App\Classes\Backend\Backend::class,
